...
So **Case 4 should still remain a relatively simple Ticket CRUD application**. We should **not introduce User, authentication, assignment, comments, audit logs, etc. yet**. Those can be added in the subsequent cases so that students can clearly see how each enterprise requirement changes the application.
